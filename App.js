...
const openDirections = (latitude, longitude, carName) => {
  // Utilisation d'un schéma d'URL universel pour les cartes
  ...
  Linking.openURL(url).catch(err => {
    // Si l'app native échoue, on ouvre Google Maps sur le web
...
const updateCarAvailability = async (carId, startDate, endDate) => {
...
<TouchableOpacity 
  ...
  onPress={() => setCurrentScreen('Payment')} // Redirection vers l'écran Payment
>
